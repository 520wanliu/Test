...
# 输入有效用户名
driver.find_element(By.ID,"username").send_keys("dddabcABCDefgge")
# 输入有效邮箱
driver.find_element(By.ID,"email").send_keys("ddd@163.com")
# 输入有效密码
driver.find_element(By.ID,"password").send_keys("1234513467024654237324632846")
# 输入有效确认密码
driver.find_element(By.ID,"repassword").send_keys("1234513467024654237324632846")
# 已阅读按钮
# 点击”立即注册“
